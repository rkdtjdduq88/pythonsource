...
# print(now) # 2023-06-14 11:51:22.200819
...
# # 참일때 실행 구문 if 조건 else 거짓일 때 실행구문

# str = "안녕하세요" if True else "반갑습니다" # 참일때 "안녕하세요" 거짓일때 "반갑습니다"
# print(str)

# date = "오전" if now.hour <12 else "오후"
# print(date)
...
# # 나이가 20세 이상 지원 가능
# #       키가 170이상이면 "A지망 지원 가능" 출력
# #       키가 160이상이면 "B지망 지원 가능" 출력
# #       나머지 "지원불가"
