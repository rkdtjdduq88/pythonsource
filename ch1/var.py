...
print("a - b = %d" % (a-b))
print("a * b = %d" % (a*b))
print("a / b = %f" % (a/b))   # 스크립트와 같은 개념(소수점까지)
print("a // b = %f" % (a//b)) # 자바와 같은 개념(몫)
print("a % b = ", (a%b))
print("a ** b = ", (a**b))

# type() : 변수 타입 확인
# str() : 문자열 반환, int() : 숫자 변환, float() : 실수, bool() : 불린 변환
print(str(3.5), type(str(3.5)))
print(int(True), type(int(True)))
print(int(False), type(int(False)))
print(bool(0.1), type(bool(0.1))) # True <class 'boo'> 0 이아니면 True
...
print(int(98.99), type(int(98.99))) # 따옴표가 있고 없고의 차이 : 문자열에서 타입변환시켜주는 것은 막음.
